...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/visualizations/timeSeries.js":[function(require,module,exports) {
...
function createTimeSeriesData() {
  ...
  var data = [];
  years.forEach(function (val, key) {
    data.push({
      date: key,
      value: val
    });
...
function createtimeSeries(width, height, source) {
  ...
  function update() {
    ...
    xAxis = function xAxis(g) {
      return g.attr("transform", "translate(0,".concat(height - margin.bottom, ")")).call(d3.axisBottom(x).ticks(width / 400).tickSizeOuter(0));
    };
    ...
    yAxis = function yAxis(g) {
      return g.attr("transform", "translate(".concat(margin.left, ",0)")).call(d3.axisLeft(y)).call(function (g) {
        ...
        return g.select(".tick:last-of-type text").clone().attr("x", 3).attr("text-anchor", "start").attr("font-weight", "bold").text(data.y);
      });
    };

    curve = d3.curveLinear;
    area = d3.area().curve(curve).x(function (d) {
      return x(d.date);
    }).y0(y(0)).y1(function (d) {
      return y(d.value);
    });
    svg.append("path").datum(data).attr("fill", "steelblue").attr("d", area);
    svg.append("g").call(xAxis).style("font-size", "20px");
    svg.append("g").call(yAxis).style("font-size", "20px");
  }
...
},{}]},{},["../../../.nvm/versions/node/v15.5.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/visualizations/timeSeries.js"], null)
//# sourceMappingURL=/timeSeries.d0323432.js.map